...
data {
  ...
  // Covariates
  int P_cov; // Number of Covariate parameters
  matrix[I,P_cov] i_cov; // Data for individuals I (resp covaraites)
...
transformed parameters {
  matrix[P, I] beta_ind;
  {
    ...
    beta_ind = rep_matrix(alpha, I) + (i_cov_load * i_covt) + (cov_chol * z); // P x I unconstrained
    if (con_n >0){
