...
//  vector[P_sku] b_trend; // Each sku will have a trend slope
  ...
  real<lower = 0, upper = .4> b_promo; // beta for sku_promo ln(dist * e^b_promo)
...
transformed parameters {
  ...
  b_attributes_npl[1:37] = k_brand * b_attributes_over[1:37]; // scale brand attributes
  b_attributes_npl[38] = b_attributes_nplspec[1]; // Length
  b_attributes_npl[39:41] = b_attributes_nplspec[2:4]; // Tier1-3
  b_attributes_npl[42:43] = b_attributes_nplspec[5:6]; // Tier1_Format
  b_attributes_npl[44:45] = b_attributes_nplspec[5:6]; // Tier2_Format
  b_attributes_npl[46:47] = b_attributes_nplspec[5:6]; // Tier3_Format
  b_attributes_npl[48:49] = b_attributes_nplspec[7:8]; // Tier4_Format
  b_attributes_npl[50:51] = k_fruit_cps * b_attributes_over[50:51]; // fruit_cps
  b_attributes_npl[52:57] = k_flavor * b_attributes_over[52:57];  // Flavor
  b_attributes_npl[58:60] = k_color * b_attributes_over[58:60];  // Color
