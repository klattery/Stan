...
//  vector[P_sku] b_trend; // Each sku will have a trend slope
  ...
  real<lower = 0, upper = 1> b_promo_exist; // beta for sku_promo ln(dist * e^b_promo)
  real<lower = 0, upper = 1> b_promo_npl; // beta for sku_promo ln(dist * e^b_promo)
...
transformed parameters {
  ...
  b_attributes_npl[46:47] = b_attributes_nplspec[5:6]; // Tier1_Format
  b_attributes_npl[48:49] = b_attributes_nplspec[5:6]; // Tier2_Format
  b_attributes_npl[50:51] = b_attributes_nplspec[5:6]; // Tier3_Format
  b_attributes_npl[52:53] = b_attributes_nplspec[7:8]; // Tier4_Format
  b_attributes_npl[54:55] = k_fruit_cps * b_attributes_over[54:55]; // fruit_cps
  b_attributes_npl[56:61] = k_flavor * b_attributes_over[56:61];  // Flavor
  b_attributes_npl[62:64] = k_color * b_attributes_over[62:64];  // Color
