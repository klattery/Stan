...
source("https://raw.githubusercontent.com/klattery/Estimation-Ecosystem/master/EE_Functions_Stan2.3.R")
...
filename$cov <- "cov_test.csv"

# OPTIONS
check_collinearity <- TRUE # May take a few minutes to check if your coding is deficient
est_aggmodel <- TRUE # Option to estimate aggregate model
